...
try{
	...
	if(isset($result)){
		foreach ($result as $key => $value) {
			...
			echo "<form  method='POST' action='./../fornecedores/excluir_fornecedor.php' >" . "<input name='id_fornecedor' value='" . $value['ID_FORNECEDOR'] . "'> <button name='excluir_fornecedor'>🗑" . "</button><BR></form>";
		}
	}else{
